...
selected voters. The main question concerned their intention to vote (`vote`) in the plebicite, which was
recorded as:
...
We can get the predicted probabilities for these separate models for the dichotomites using `predict.nestedLogit()`
