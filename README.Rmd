...
for a **polytomous** response (>2 categories), such as: 
...
The basic model for this situation is the standard **multinomial logistic model**
which compares response categories to a reference level (fit by: e.g., `nnet::multinom()`).
...
Nested dichotomies are statistically independent, and hence provide an
