...
The figure below shows two different ways that a four-category polytomous response $Y = \{1, 2, 3, 4\}$ can be decomposed as
three nested dichotomies among the levels.
